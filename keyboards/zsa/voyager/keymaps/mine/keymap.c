...
[MAIN] = LAYOUT(
      ...
      KC_COLN , KC_A_G , KC_R_A , KC_S_S , KC_T_C        , KC_G     ,     KC_M           , KC_N_C        , KC_E_S   , KC_I_A , KC_O_G       , KC_QUOT   ,
      KC_EQL  , KC_Z   , KC_X   , KC_C   , KC_D          , KC_V     ,     KC_K           , KC_H          , KC_COMMA , KC_DOT , KC_SLSH      , KC_UNDS   ,
                                           LT(1, KC_ENT) , KC_ESC_S ,     LT(3, KC_BSPC) , LT(2, KC_SPC)
),
...
[NAVIGATION] = LAYOUT(
      ...
      __ , KC_LGUI , KC_LALT , KC_LSFT , KC_LCTL , __ ,     KC_LEFT , KC_DOWN , KC_UP   , KC_RIGHT , C(S(KC_TAB)) , __,
